...
Ray cluster initialisation can be customised programmatically via `ray_cluster.init_cluster(**kwargs)` before starting the simulation. For example:
...
`entangled_log.jsonl`.
Parse the consolidated logs directly to inspect simulation results.
